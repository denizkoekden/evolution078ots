...
//	LOG_MESSAGE("main", EVENT, 1, "Starting server");
	...
	WSADATA wsaData;
	wVersionRequested = MAKEWORD( 2, 2 ); // Winsock 2.2 (was 1.1) — required by <winsock2.h>/ws2_32
	...
	if((LOBYTE(wsaData.wVersion) != 2) || (HIBYTE(wsaData.wVersion) != 2)) {
		WSACleanup( );
		ErrorMessage("No Winsock 2.2 found!");
		return -1;
	}
#endif
