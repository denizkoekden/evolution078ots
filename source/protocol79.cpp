...
void Protocol79::sendCreatureSkull(const Creature* creature, Skulls_t newSkull /*= SKULL_NONE*/)
{
	if(canSee(creature)){
		NetworkMessage msg;
		msg.AddByte(0x90);
...
#ifdef __XID_CTRL_Z__
void Protocol79::parseBugReport(NetworkMessage &msg)
{
...
#ifdef __XID_CTRL_Y__
void Protocol79::parseBanPlayer(NetworkMessage &msg)
{
	std::string name = msg.GetString();
